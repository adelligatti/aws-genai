# Amazon Bedrock Claude 3 Streaming Response POC
...
![A gif of a screen recording show casing the Amazon Bedrock Claude 3 Streaming Response POC functionality](images/demo.gif)
